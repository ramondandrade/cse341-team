...
routes.post('/', characterValidate.validatePost, characterController.createCharacter);

// PUT /character/{char_id} - Update character by ID
routes.put('/:char_id', characterValidate.validatePost, characterController.updateCharacter);
